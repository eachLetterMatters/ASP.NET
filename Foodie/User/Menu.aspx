    ...
    <section class="food_section layout_padding">
        <div class="container">
            ...
            <ul class="filters_menu">
                <%--list filtering using css classes--%>
                ...
                <asp:Repeater ID="repeaterCategory" runat="server">
                    <ItemTemplate>
                        <li data-filter=".<%# Regex.Replace(Eval("name").ToString().ToLower(), @"\s+","") %>"
                            data-id="<%# Eval("category_id") %>"><%# Eval("name") %></li>
                    </ItemTemplate>
                </asp:Repeater>
            </ul>
            ...
            <div class="filters-content">
                <div class="row grid">
                    <asp:Repeater ID="repeaterProducts" runat="server" OnItemCommand="repeaterProducts_ItemCommand">
                        <itemtemplate>
                            <div class="col-sm-6 col-lg-4 all <%# Regex.Replace(Eval("category_name").ToString().ToLower(), @"\s+", "") %>">
                                <div class="box">
                                    <div>
                                        <div class="img-box">
                                            <img src="<%# Foodie.Utils.GetImageUrl(Eval("image_url")) %>" alt="">
                                        </div>
                                        <div class="detail-box">
                                            ...
                                            <div class="options">
                                                <h6><%# Eval("price") %> $</h6>
                                                <asp:LinkButton runat="server" ID="lbAddToCart" CommandName="addToCart" CommandArgument='<%# Eval("product_id") %>'>
                                                    <%--cart icon--%>
